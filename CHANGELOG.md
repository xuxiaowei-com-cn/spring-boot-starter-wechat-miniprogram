...
- spring-security-oauth2-authorization-server 从 0.3.1（自己构建的支持 JDK 17 的版本） 升级 到 1.0.0-M1（官方首次支持 JDK
  17）
  弃用自己构建的 io.xuxiaowei.security.next:spring-security-oauth2-authorization-server（官方已支持 JDK 17）
...
## JDK 17 Build 0.0.1-alpha.2 2022-07-14
...
## JDK 17 Build 0.0.1-alpha.1 2022-07-14
